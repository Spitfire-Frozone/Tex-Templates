...
\usepackage{xcolor}  %Allows for table edition flexibility [table,xcdraw now global options due to clash with package pgfornament] and usage of certain colours.
...
\begin{appendices}
\chapter{Classical Mechanics: Newtonian to Lagrangian}
...
\chapter{Impact of 2-Lepton Significance on the Total}
