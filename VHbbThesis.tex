...
\usepackage[backend=biber,style=numeric-comp,bibencoding=ascii]{biblatex} %like ieee(tr) sytle but with clickable doi links. 
...
\newcommand{\gev}{\ensuremath{~GeV }}								 %Units of energy
	\newcommand{\gevo}{\ensuremath{~GeV}}								  %Units of energy at the end of a phrase or sentence
